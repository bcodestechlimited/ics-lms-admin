...
import {IssueCertificateModal} from "../../components/modals/issue-certificate-modal";
import Shell from "../../components/shell";
import {CertificateTable} from "../../components/tables/certificate-table";
import {Button} from "../../components/ui/button";
import {useUploadCertificateTemplate} from "../../hooks/use-admin";
...
const CertificatesPage = () => {
  ...
  const handleIssueCertificate = (cert) => {
    console.log("cert", cert);
    setModal("open-issue-certificate-modal");
    setUser(cert);
  };
  ...
  return (
    <Shell pageHeader="Certificates" pageTitle="Certificates">
      <div className="">
        <CertificateTable handleIssueCertificate={handleIssueCertificate} />
      ...
      <section className="bg-white border rounded-xl mt-20 p-4">
          ...
          <h2 className="font-semibold text-secondary text-xl flex items-center gap-x-1">
            ...
            <span
              ...
              data-tooltip-content={
                "Upload signature that would be on the student's certificate"
              }
            >
              {" "}
              <Info size={15} />{" "}
